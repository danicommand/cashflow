...
const en = {
  ...
  "summary.safeToSpend": "Safe to spend",
  "safeBreakdown.title": "Balance minus reserved essentials",
  "safeBreakdown.balance": "Balance {amount}",
  "safeBreakdown.reserved": "Reserved essentials −{amount}",
  "runway.title": "Cash runway",
  "runway.hint": "Projected through this month",
  "runway.lowest": "Lowest {amount}",
  "runway.chartLabel": "Projected balance chart",
  "runway.start": "Starting balance",
  ...
  "summary.overview": "Financial overview",
  ...
  "planner.title": "Pay next",
  "planner.hint": "Smart order",
  "filter.label": "Filter bills",
  "filter.all": "All",
  ...
  "sort.smart": "Smart",
  "sort.date": "Due date",
  "sort.amount": "Highest amount",
  "sort.priority": "Priority",
  "priority.label": "Priority",
  "priority.essential": "Essential",
  "priority.important": "Important",
  "priority.flexible": "Flexible",
  ...
  "action.deleteNamed": "Delete {description}",
  "action.edit": "Edit",
  "action.markPaid": "Mark paid",
  "action.paymentDetails": "Payment details: {description}",
  ...
  "calendar.net": "Net that day",
  "calendar.previousDay": "Previous day",
  "calendar.nextDay": "Next day",
  "calendar.nextPlanned": "Next planned",
  "calendar.monthSnapshot": "Month snapshot",
  "calendar.scheduled": "{count} scheduled",
  "calendar.activeDates": "{count} active days",
  ...
  "settings.dashboardPriority": "Dashboard priority",
  "settings.dashboardPriorityHint": "Choose the number featured at the top of each month.",
  "settings.dashboardCards": "Dashboard cards",
  "settings.dashboardCardsHint": "Choose what appears and the order it appears in.",
  "settings.showMetric": "Show {metric}",
  "settings.moveUp": "Move {metric} up",
  "settings.moveDown": "Move {metric} down",
  "settings.monthView": "Month view",
  "settings.compactRows": "Use compact bill rows",
  "settings.showSettled": "Show settled bills by default",
  "settings.reminders": "Due reminders",
  "settings.remindersHint": "Notifications are checked when you open the app on this device.",
  "settings.reminderLead": "Remind me",
  "settings.reminderToday": "On the due date",
  "settings.reminderOneDay": "1 day before",
  "settings.reminderThreeDays": "3 days before",
  "settings.reminderSevenDays": "7 days before",
  "settings.enableReminders": "Enable reminders",
  "settings.disableReminders": "Disable reminders",
  "settings.remindersDenied": "Notifications are blocked in this browser's settings.",
  "settings.remindersUnsupported": "This browser does not support notifications.",
  "reminder.title": "Cashflow reminder",
  "reminder.body": "{description} needs attention.",
  "theme.system": "System",
  "theme.light": "Light",
  "theme.dark": "Dark",
...
const pt: Record<TranslationKey, string> = {
  ...
  "summary.safeToSpend": "Livre para gastar",
  "safeBreakdown.title": "Saldo menos essenciais reservados",
  "safeBreakdown.balance": "Saldo {amount}",
  "safeBreakdown.reserved": "Essenciais reservados −{amount}",
  "runway.title": "Fluxo do mês",
  "runway.hint": "Projeção até o fim do mês",
  "runway.lowest": "Menor saldo {amount}",
  "runway.chartLabel": "Gráfico do saldo projetado",
  "runway.start": "Saldo inicial",
  ...
  "summary.overview": "Resumo financeiro",
  ...
  "action.deleteNamed": "Excluir {description}",
  "action.edit": "Editar",
  "action.markPaid": "Marcar como pago",
  "action.paymentDetails": "Detalhes do pagamento: {description}",
  ...
  "calendar.net": "Saldo do dia",
  "calendar.previousDay": "Dia anterior",
  "calendar.nextDay": "Próximo dia",
  "calendar.nextPlanned": "Próximo agendado",
  "calendar.monthSnapshot": "Resumo do mês",
  "calendar.scheduled": "{count} agendado(s)",
  "calendar.activeDates": "{count} dias ativos",
  "calendar.thisWeek": "Nesta semana",
  ...
  "settings.theme": "Tema",
  "settings.dashboardPriority": "Prioridade do painel",
  "settings.dashboardPriorityHint": "Escolha o número em destaque no topo de cada mês.",
  "settings.dashboardCards": "Cartões do painel",
  "settings.dashboardCardsHint": "Escolha o que aparece e em qual ordem.",
  "settings.showMetric": "Mostrar {metric}",
  "settings.moveUp": "Mover {metric} para cima",
  "settings.moveDown": "Mover {metric} para baixo",
  "settings.monthView": "Visão do mês",
  "settings.compactRows": "Usar linhas compactas",
  "settings.showSettled": "Mostrar contas quitadas por padrão",
  "settings.reminders": "Lembretes de vencimento",
  "settings.remindersHint": "As notificações são verificadas ao abrir o app neste aparelho.",
  "settings.reminderLead": "Lembrar",
  "settings.reminderToday": "No vencimento",
  "settings.reminderOneDay": "1 dia antes",
  "settings.reminderThreeDays": "3 dias antes",
  "settings.reminderSevenDays": "7 dias antes",
  "settings.enableReminders": "Ativar lembretes",
  "settings.disableReminders": "Desativar lembretes",
  "settings.remindersDenied": "As notificações estão bloqueadas nas configurações do navegador.",
  "settings.remindersUnsupported": "Este navegador não oferece suporte a notificações.",
  "reminder.title": "Lembrete do Cashflow",
  "reminder.body": "{description} precisa de atenção.",
